...
const LatestDealsScreen = ({navigation}: any) => {
  ...
  const loadDeals = async () => {
    try {
      setLoading(true);
      const response = await MockApiService.getLatestDeals(1, 30);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>📈 Latest Deals</Text>
      </View>
...
export default LatestDealsScreen;