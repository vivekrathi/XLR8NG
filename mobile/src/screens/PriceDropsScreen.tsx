...
const PriceDropsScreen = ({navigation}: any) => {
  ...
  const loadDeals = async () => {
    try {
      setLoading(true);
      const response = await MockApiService.getPriceDrops(1, 30);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>💸 Recent Price Drops</Text>
      </View>
...
export default PriceDropsScreen;